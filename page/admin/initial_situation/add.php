...
<section id="main">
      <section id="form">
        ...
        <form id="initial-situation-add">
          ...
          <label for="">清醒度</label>
          <div><input type="number" min="2"  id="awake-degree"><label for="" id="awake-degree-error">必填</label></div>
          <label>圖片</label>
    ...
    <script src="<?=ROOT.'/js/page/admin/initial_situation/add.js'?>" type="module"></script>
